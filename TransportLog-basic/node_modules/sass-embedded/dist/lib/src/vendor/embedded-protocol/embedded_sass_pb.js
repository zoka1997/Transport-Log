...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.sass.embedded_protocol.InboundMessage.CompileRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            charset: jspb.Message.getBooleanFieldWithDefault(msg, 13, false)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
/**
 * optional bool charset = 13;
 * @return {boolean}
 */
proto.sass.embedded_protocol.InboundMessage.CompileRequest.prototype.getCharset = function () {
 ...
 * @return {!proto.sass.embedded_protocol.InboundMessage.CompileRequest} returns this
 */
proto.sass.embedded_protocol.InboundMessage.CompileRequest.prototype.setCharset = function (value) {
