...
export const PAGE_BG_TEXTFLOOR_FILTER_ID = "page-text-flood";
...
export class CanvasManagerBase {
    ...
    constructor(actualZoom: number, dom: DOMManipulator) {
    ...
    protected createTextFloodFilter(key: string, parent: SVGElement, pageColor: number) {
        this.getOrCreateElement(key, new TextFloodFilterPrimitive(PAGE_BG_TEXTFLOOR_FILTER_ID, pageColor), parent);
    }
