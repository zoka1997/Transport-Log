...
export class CanvasItemsManager extends CanvasManager implements IMouseOperationsListener,
    ...
    constructor(viewElement: SVGElement, zoomLevel: number, dom: DOMManipulator) {
        super(zoomLevel, dom);
    ...
    getPrimitives(item: DiagramItem): SvgPrimitive<SVGElement>[] {
        if(!this.primitives[item.key])
    ...
    applyShapeChange(shape: Shape, type: ItemChangeType, isValid: boolean): void {
        ...
        switch(type) {
            case ItemChangeType.Create:
                ...
                this.itemElements[key] = this.createItemElements(key, this.getPrimitives(shape),
            ...
            case ItemChangeType.Update:
                ...
                this.changeItemElements(this.getPrimitives(shape), this.itemElements[key],
                    type === ItemChangeType.UpdateStructure);
    ...
    applyConnectorChange(connector: Connector, type: ItemChangeType, isValid: boolean): void {
        ...
        switch(type) {
            case ItemChangeType.Create:
                ...
                this.itemElements[key] = this.createItemElements(key, this.getPrimitives(connector),
            ...
            case ItemChangeType.Update:
                ...
                this.changeItemElements(this.getPrimitives(connector), this.itemElements[key],
                    type === ItemChangeType.UpdateStructure);
