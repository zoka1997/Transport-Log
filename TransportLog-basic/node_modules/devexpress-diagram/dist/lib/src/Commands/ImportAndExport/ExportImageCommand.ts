...
export abstract class ExportImageCommand extends ExportImportCommandBase {
    ...
    private getExportManager(): CanvasExportManager {
        ...
        return this.exportManager || (this.exportManager = new CanvasExportManager(itemsManager.itemsContainer, measurer));
    }
    private createItemsManager(measurer: ITextMeasurer): CanvasItemsManager {
        ...
        const canvasManager = new CanvasItemsManager(this.svgElement, 1, new ExportDOMManipulator(measurer));
